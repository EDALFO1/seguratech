...
<div class="pagetitle d-flex justify-content-between align-items-center">
    <div>
        <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Editar Empresa</h1>
...
<div class="card border-0 shadow-sm">
    <div class="card-header py-3">
        <h5 class="mb-0 fw-semibold">{{ $empresa->nombre ?? 'Editar' }}</h5>
    </div>
    <div class="card-body pt-4">
        <form action="{{ route('empresas.update', $empresa) }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4 pt-3 border-top">
                ...
                <form action="{{ route('empresas.destroy', $empresa) }}" method="POST" class="ms-auto form-delete" data-nombre="{{ $empresa->nombre ?? '' }}">
                    @csrf @method('DELETE')

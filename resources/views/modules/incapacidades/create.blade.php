...
<div class="pagetitle d-flex justify-content-between align-items-center">
    <div>
        <h1 class="mb-0"><i class="bi bi-file-medical me-2"></i>Registrar Incapacidad</h1>
...
<div class="card shadow-sm border-0">
    <div class="card-header py-3">
        <h5 class="mb-0 fw-semibold">Datos de la incapacidad</h5>
    </div>
    <div class="card-body pt-4">
        <form action="{{ route('incapacidades.store') }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4 pt-3 border-top">
                ...
                <a href="{{ route('incapacidades.index') }}" class="btn btn-outline-secondary">
                    Cancelar
                </a>
            </div>
        </form>

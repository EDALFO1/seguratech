...
<div class="pagetitle d-flex justify-content-between align-items-center">
    <div>
        <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Editar Documento</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{ route('documentos.index') }}">Tipos de Documento</a></li>
...
<div class="card border-0 shadow-sm">
    <div class="card-header py-3">
        <h5 class="mb-0 fw-semibold">{{ $documento->nombre ?? 'Editar' }}</h5>
    </div>
    <div class="card-body pt-4">
        <form action="{{ route('documentos.update', $documento) }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4 pt-3 border-top">
                ...
                <form action="{{ route('documentos.destroy', $documento) }}" method="POST" class="ms-auto form-delete" data-nombre="{{ $documento->nombre ?? '' }}">
                    @csrf @method('DELETE')

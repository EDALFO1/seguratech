...
<div class="pagetitle d-flex justify-content-between align-items-center">
    <div>
        <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Editar Caja</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cajas.index') }}">Cajas de Compensación</a></li>
...
<div class="card border-0 shadow-sm">
    <div class="card-header py-3">
        <h5 class="mb-0 fw-semibold">{{ $caja->nombre ?? 'Editar' }}</h5>
    </div>
    <div class="card-body pt-4">
        <form action="{{ route('cajas.update', $caja) }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4 pt-3 border-top">
                ...
                <form action="{{ route('cajas.destroy', $caja) }}" method="POST" class="ms-auto form-delete" data-nombre="{{ $caja->nombre ?? '' }}">
                    @csrf @method('DELETE')

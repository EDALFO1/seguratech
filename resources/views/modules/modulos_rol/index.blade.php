...
<div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
        <h1 class="mb-0"><i class="bi bi-person-gear me-2"></i>Módulos por Rol</h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-3 fw-semibold text-capitalize">{{ $rol->nombre }}</td>
                        <td class="text-center">
                            <span class="badge bg-primary rounded-pill">{{ $rol->modulos()->count() }}</span>
                        </td>
                        <td class="text-center">
                            <a href="{{ route('modulos-rol.edit', $rol) }}"

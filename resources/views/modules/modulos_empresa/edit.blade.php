...
<div class="pagetitle d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
        <h1 class="mb-0"><i class="bi bi-building-gear me-2"></i>{{ $empresa->nombre }}</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{ route('modulos-empresa.index') }}">Módulos por Empresa</a></li>
...
<form action="{{ route('modulos-empresa.update', $empresa) }}" method="POST">
    @csrf @method('PUT')
    ...
    <div class="mt-4 d-flex gap-2">
        ...
        <a href="{{ route('modulos-empresa.index') }}" class="btn btn-outline-secondary">Cancelar</a>
    </div>

...
<div class="pagetitle d-flex justify-content-between align-items-center">
    <div>
        <h1 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Editar Parámetro</h1>
...
<div class="card border-0 shadow-sm">
    <div class="card-header py-3">
        <h5 class="mb-0 fw-semibold">Año {{ $parametro_anual->anio ?? '' }}</h5>
    </div>
    <div class="card-body pt-4">
        <form action="{{ route('parametros_anuales.update', $parametro_anual) }}" method="POST">
            ...
            <div class="d-flex gap-2 mt-4 pt-3 border-top">
                ...
                <form action="{{ route('parametros_anuales.destroy', $parametro_anual) }}" method="POST" class="ms-auto form-delete" data-nombre="{{ $parametro_anual->anio ?? '' }}">
                    @csrf @method('DELETE')
